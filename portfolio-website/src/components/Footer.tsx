...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-transparent backdrop-blur-xl border-t border-white/20 ring-1 ring-white/10 shadow-2xl text-foreground/70 dark:text-foreground-dark/70 py-6 mt-auto transition-colors duration-500">
